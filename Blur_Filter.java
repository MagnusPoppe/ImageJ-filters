 ...
 */
public class Blur_Filter implements PlugInFilter 
{
	ImagePlus imp;

	static int[] HFILTER; //= {2, 4, 8};
	static int[] VFILTER; //= {8, 4, 2};
	...
	public void run(ImageProcessor ip)
	{
		...
		// HENTES UT GRUNNET BRUKER FILTER STØRRELSE:
		HFILTER = promptUserFilter( );
		VFILTER = HFILTER;
	    hfiltersize = HFILTER.length / 2;
	    vfiltersize = hfiltersize;
